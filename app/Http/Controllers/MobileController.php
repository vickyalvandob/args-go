...
class MobileController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('mobile.user.dashboard', compact('rewardCollect','puzzleCollect','puzzlePieceCollect','coin','puzzlePiece','reward','antagonist','weaponCollects'));
    }
    ...
    {
        return view('mobile.user.password');
    }
    ...
    public function topUp_index()
    {
        ...
        return view('mobile.user.topUp.index', compact('topUps'));
    }
    ...
    public function payout_index()
    {
        ...
        return view('mobile.user.payout.index', compact('payouts'));
    }
    ...
    public function transfer_index()
    {
        ...
        return view('mobile.user.transfer.index', compact('transfers'));
    }
    ...
    public function collection_index()
    {
        ...
        return view('mobile.user.collection.index', compact('coin','puzzle','puzzlePiece','reward'));
    }
    ...
    public function coinCollect_index()
    {
        ...
        return view('mobile.user.coinCollect.index', compact('coinCollects'));
    }
    ...
    public function coinClaim_index()
    {
        ...
        return view('mobile.user.coinClaim.index', compact('coinClaims'));
    }
    ...
    public function rewardCollect_index()
    {
        ...
        return view('mobile.user.rewardCollect.index', compact('rewardCollects','rewardCollectHistorys'));
    }
    ...
    public function mall_index()
    {
        ...
        return view('mobile.user.rewardSell.index', compact('rewardBuys','rewards','rewardSells'));
    }
    ...
    public function rewardClaim_index()
    {
        ...
        return view('mobile.user.rewardClaim.index', compact('rewardClaims'));
    }
    ...
    public function puzzleCollect_index()
    {
        ...
        return view('mobile.user.puzzleCollect.index', compact('puzzlePieceCollectHistorys','puzzleCollects','puzzleCollectHistorys','puzzles'));
    }
    ...
    public function puzzlePieceSell_index()
    {
        ...
        return view('mobile.user.puzzlePieceSell.index', compact('puzzlePieceBuys','pieces','puzzlePieceSells'));
    }
    ...
    public function puzzleClaim_index()
    {
        ...
        return view('mobile.user.puzzleClaim.index', compact('puzzleClaims'));
    }
    ...
    public function weapon_index()
    {
        ...
        return view('mobile.user.weapon.index', compact('weapons'));
    }
    ...
    public function weaponCollect_index()
    {
        ...
        return view('mobile.user.weaponCollect.index', compact('weaponCollects'));
    }

    public function weaponAttack_index()
    {
        $weaponAttacks = weaponAttack::orderby('id', 'desc')->where('user_id',Auth::user()->id)->paginate(5);
        return view('mobile.user.weaponAttack.index', compact('weaponAttacks'));
    }
    ...
    public function weaponBuy_index()
    {
        ...
        return view('mobile.user.weaponBuy.index', compact('weaponBuys'));
    }
    ...
    public function antagonistAttack_index()
    {
        ...
        return view('mobile.user.antagonistAttack.index', compact('antagonistAttacks'));
    }
