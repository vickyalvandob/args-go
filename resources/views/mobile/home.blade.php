...
@section('content')
            <div class="container mb-4 text-center">
                <div class="card dark-blue shadow ">
                    <div class="card-body">
                        <!-- Swiper -->
            ...
            <div class="container mb-4">
                <div class="card" id="addtodevice">
                    <div class="card-body text-center">
                        <div class="row mb-3">
                            <div class="col-10 col-md-4 mx-auto"><img src="{{ asset('finwallet') }}/img/install-app.png" alt="" class="mw-100"></div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body text-left text-md-center">
                        ...
                        <div class="row my-3 justify-content-center">
                            <div class="col-10 col-md-4 mx-auto"><img src="{{ asset('finwallet') }}/img/about.png" alt="" class="mw-100"></div>
                        </div>
